...
const Login = ({ changePage, onLogin }) => {
    ...
    return (
        <div id="page-login" className="auth-page active-page">
            <div className="auth-container">
                ...
                <div className="auth-right">
                    <div className="auth-form-container">
                        ...
                        <p className="auth-subtitle">Bienvenido de vuelta a LooP</p>
                        <form id="login-form" className="auth-form" onSubmit={handleSubmit}>
                            <div className="form-group">
                                <label htmlFor="login-email">Correo electrónico</label>
                                <input type="email" id="login-email" placeholder="tu@email.com" required value={email} onChange={(e) => setEmail(e.target.value)} />
                            </div>
                            <div className="form-group">
                            ...
                            <button type="submit" className="btn btn-primary btn-full" id="btn-login">Iniciar Sesión</button>
                        </form>
                        <div className="auth-divider">
                            <span>o continúa con</span>
                        </div>
                        <div className="social-auth">
                            <button className="btn-social" id="btn-google">
                        ...
                        <p className="auth-switch">¿No tienes cuenta? <a href="#" onClick={(e) => { e.preventDefault(); changePage('page-register'); }}>Crear cuenta</a></p>
                    </div>
                </div>
            </div>
        </div>
